...
# Account Information
to = 'lee_uk_lee@yahoo.co.uk' # Email to send to.
gmail_user = 'leeuklee@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'Dogfucker78' # Gmail password.
...
my_ip_a = 'Your %s ip is' % ip_type_a
my_ip_b = 'Your %s ip is' % ip_type_b
